...
turtle = pygame.image.load(os.getcwd() + r"\turtle.png")
...
pygame.draw.line(screen, (128, 128, 128), (0, 71), (x, 71), 144)
pygame.display.flip()
"""
sets up the border between playable area and scoreboard
"""

pos_fruit = [random.randint(0, x-68), random.randint(72, y-52)]
"""
...
while True:
    ...
    if key[pygame.K_w] and pos[1] > 72:
        pos[1] -= 1
    elif key[pygame.K_s] and pos[1] < y-52:
        pos[1] += 1
    elif key[pygame.K_a] and pos[0] > 0:
        pos[0] -= 1
